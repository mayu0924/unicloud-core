...
import com.unicloud.core.widget.utils.TextViewUtils;


public class UTextViewHelper extends UBaseHelper<TextView> {
    ...
    public UTextViewHelper(Context context, TextView view, AttributeSet attrs) {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.UTextView);
        //icon
        //Vector兼容处理
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mIconNormal = a.getDrawable(R.styleable.UTextView_icon_src_normal);
            mIconPressed = a.getDrawable(R.styleable.UTextView_icon_src_pressed);
            mIconUnable = a.getDrawable(R.styleable.UTextView_icon_src_unable);
            mIconSelected = a.getDrawable(R.styleable.UTextView_icon_src_selected);
        } else {
            int normalId = a.getResourceId(R.styleable.UTextView_icon_src_normal, -1);
            int pressedId = a.getResourceId(R.styleable.UTextView_icon_src_pressed, -1);
            int unableId = a.getResourceId(R.styleable.UTextView_icon_src_unable, -1);
            int selectedId = a.getResourceId(R.styleable.UTextView_icon_src_selected, -1);
        ...
        mIconWidth = a.getDimensionPixelSize(R.styleable.UTextView_icon_width, 0);
        mIconHeight = a.getDimensionPixelSize(R.styleable.UTextView_icon_height, 0);
        mIconDirection = a.getInt(R.styleable.UTextView_icon_direction, ICON_DIR_LEFT);
        //text
        mTextColorNormal = a.getColor(R.styleable.UTextView_text_color_normal, mView.getCurrentTextColor());
        mTextColorPressed = a.getColor(R.styleable.UTextView_text_color_pressed, 0);
        mTextColorUnable = a.getColor(R.styleable.UTextView_text_color_unable, 0);
        mTextColorSelected = a.getColor(R.styleable.UTextView_text_color_selected, 0);
        //typeface
        mTypefacePath = a.getString(R.styleable.UTextView_text_typeface);
        //drawableWithText
        mDrawableWithText = a.getBoolean(R.styleable.UTextView_icon_with_text, false);
    ...
    public UTextViewHelper setTypeface(String typefacePath) {
    ...
    public UTextViewHelper setIconNormal(Drawable icon) {
    ...
    public UTextViewHelper setIconPressed(Drawable icon) {
    ...
    public UTextViewHelper setIconUnable(Drawable icon) {
    ...
    public UTextViewHelper setIconSelected(Drawable icon) {
    ...
    public UTextViewHelper setIconSize(int iconWidth, int iconHeight) {
    ...
    public UTextViewHelper setIconWidth(int iconWidth) {
        this.mIconWidth = iconWidth;
        setIcon();
        return this;
    }
    ...
    public UTextViewHelper setIconHeight(int iconHeight) {
        this.mIconHeight = iconHeight;
        setIcon();
        return this;
    }
    ...
    public UTextViewHelper setIconDirection(int iconDirection) {
        ...
        if (drawable != null) {
            ...
            mView.post(new Runnable() {
                ...
                public void run() {
                    ...
                    //水平方向计算
                    float textWidth = TextViewUtils.Companion.get().getTextWidth(mView, drawableWidthFinal, mPaddingLeft, mPaddingRight, drawablePaddingHorizontalFinal);
                    ...
                    //垂直方向计算
                    float textHeight = TextViewUtils.Companion.get().getTextHeight(mView, drawableHeightFinal, mPaddingTop, mPaddingBottom, drawablePaddingVerticalFinal);
    ...
    public UTextViewHelper setTextColorNormal(@ColorInt int textColor) {
    ...
    public UTextViewHelper setTextColorPressed(@ColorInt int textColor) {
    ...
    public UTextViewHelper setTextColorUnable(@ColorInt int textColor) {
    ...
    public UTextViewHelper setTextColorSelected(@ColorInt int textColor) {
    ...
    public UTextViewHelper setTextColor(@ColorInt int normal, @ColorInt int pressed, @ColorInt int unable, @ColorInt int selected) {

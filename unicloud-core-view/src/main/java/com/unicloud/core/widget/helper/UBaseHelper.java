...
import com.unicloud.core.widget.shadow.ShadowDrawable;


public class UBaseHelper<T extends View> {
    /**
    ...
    public UBaseHelper(Context context, T view, AttributeSet attrs) {
        mView = view;
        mContext = context;
    ...
    public UBaseHelper setGradientRadius(float gradientRadius) {
    ...
    public UBaseHelper setGradientCenterX(float gradientCenterX) {
    ...
    public UBaseHelper setGradientCenterY(float gradientCenterY) {
     ...
     * @return
     */
    public UBaseHelper setGradientType(int gradientType) {
    ...
    public UBaseHelper setGradientOrientation(GradientDrawable.Orientation orientation) {
    ...
    public UBaseHelper setStateBackgroundColor(@ColorInt int normal, @ColorInt int pressed, @ColorInt int unable, @ColorInt int checked, @ColorInt int selected) {
    ...
    public UBaseHelper setStateBackgroundColorArray(int[] normalArray, int[] pressedArray, int[] unableArray, int[] checkedArray, int[] selectedArray) {
    ...
    public UBaseHelper setStateBackgroundColor(Drawable normal, Drawable pressed, Drawable unable, Drawable checked, Drawable selected) {
    ...
    public UBaseHelper setBackgroundColorNormal(@ColorInt int colorNormal) {
    ...
    public UBaseHelper setBackgroundColorNormalArray(int[] colorNormalArray) {
    ...
    public UBaseHelper setBackgroundDrawableNormal(Drawable drawableNormal) {
    ...
    public UBaseHelper setBackgroundColorPressed(@ColorInt int colorPressed) {
    ...
    public UBaseHelper setBackgroundColorPressedArray(int[] colorPressedArray) {
    ...
    public UBaseHelper setBackgroundDrawablePressed(Drawable drawablePressed) {
    ...
    public UBaseHelper setBackgroundColorUnable(@ColorInt int colorUnable) {
    ...
    public UBaseHelper setBackgroundDrawableUnable(Drawable drawableUnable) {
    ...
    public UBaseHelper setBackgroundColorUnableArray(int[] colorUnableArray) {
    ...
    public UBaseHelper setBackgroundColorChecked(@ColorInt int colorChecked) {
    ...
    public UBaseHelper setBackgroundColorSelected(@ColorInt int colorSelected) {
    ...
    public UBaseHelper setBackgroundColorCheckedArray(int[] colorCheckedArray) {
    ...
    public UBaseHelper setBackgroundColorSelectedArray(int[] colorSelectedArray) {
    ...
    public UBaseHelper setBackgroundDrawableChecked(Drawable drawableChecked) {
    ...
    public UBaseHelper setBackgroundDrawableSelected(Drawable drawableSelected) {
    ...
    public UBaseHelper setShadowRadius(int shadowRadius) {
    ...
    public UBaseHelper setShadowColor(int shadowColor) {
    ...
    public UBaseHelper setShadowDx(int shadowDx) {
    ...
    public UBaseHelper setShadowDy(int shadowDy) {
    ...
    public UBaseHelper setUseRipple(boolean useRipple) {
    ...
    public UBaseHelper setRippleColor(@ColorInt int rippleColor) {
    ...
    public UBaseHelper setRippleMaskDrawable(Drawable rippleMaskDrawable) {
    ...
    public UBaseHelper setBorderWidthNormal(int width) {
    ...
    public UBaseHelper setBorderColorNormal(@ColorInt int color) {
    ...
    public UBaseHelper setBorderWidthPressed(int width) {
    ...
    public UBaseHelper setBorderColorPressed(@ColorInt int color) {
    ...
    public UBaseHelper setBorderColorChecked(@ColorInt int color) {
    ...
    public UBaseHelper setBorderColorSelected(@ColorInt int color) {
    ...
    public UBaseHelper setBorderWidthChecked(int width) {
    ...
    public UBaseHelper setBorderWidthSelected(int width) {
    ...
    public UBaseHelper setBorderWidthUnable(int width) {
    ...
    public UBaseHelper setBorderColorUnable(@ColorInt int color) {
    ...
    public UBaseHelper setBorderWidth(int normal, int pressed, int unable, int checked,
                                      int selected) {
    ...
    public UBaseHelper setBorderColor(@ColorInt int normal, @ColorInt int pressed,
    ...
    public UBaseHelper setBorderDashWidth(float dashWidth) {
    ...
    public UBaseHelper setBorderDashGap(float dashGap) {
    ...
    public UBaseHelper setBorderDash(float dashWidth, float dashGap) {
        this.mBorderDashWidth = dashWidth;
        this.mBorderDashGap = dashGap;
        setBorder();
        return this;
    ...
    public UBaseHelper setCornerRadiusTopLeft(float topLeft) {
    ...
    public UBaseHelper setCornerRadiusTopRight(float topRight) {
        this.mCornerRadius = -1;
    ...
    public UBaseHelper setCornerRadiusBottomRight(float bottomRight) {
        this.mCornerRadius = -1;
    ...
    public UBaseHelper setCornerRadiusBottomLeft(float bottomLeft) {
        this.mCornerRadius = -1;
    ...
    public UBaseHelper setCornerRadius(float topLeft, float topRight, float bottomRight,
                                       float bottomLeft) {
        this.mCornerRadius = -1;
        this.mCornerRadiusTopLeft = topLeft;
        this.mCornerRadiusTopRight = topRight;

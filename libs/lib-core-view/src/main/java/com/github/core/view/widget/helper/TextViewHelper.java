...
import com.github.core.view.widget.utils.TextViewUtils;


public class TextViewHelper extends BaseHelper<TextView> {
    ...
    public TextViewHelper(Context context, TextView view, AttributeSet attrs) {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mIconNormal = a.getDrawable(R.styleable.XTextView_icon_src_normal);
            mIconPressed = a.getDrawable(R.styleable.XTextView_icon_src_pressed);
            mIconUnable = a.getDrawable(R.styleable.XTextView_icon_src_unable);
            mIconSelected = a.getDrawable(R.styleable.XTextView_icon_src_selected);
        } else {
            int normalId = a.getResourceId(R.styleable.XTextView_icon_src_normal, -1);
            int pressedId = a.getResourceId(R.styleable.XTextView_icon_src_pressed, -1);
            int unableId = a.getResourceId(R.styleable.XTextView_icon_src_unable, -1);
            int selectedId = a.getResourceId(R.styleable.XTextView_icon_src_selected, -1);
        ...
        mIconWidth = a.getDimensionPixelSize(R.styleable.XTextView_icon_width, 0);
        mIconHeight = a.getDimensionPixelSize(R.styleable.XTextView_icon_height, 0);
        mIconDirection = a.getInt(R.styleable.XTextView_icon_direction, ICON_DIR_LEFT);
        //text
        mTextColorNormal = a.getColor(R.styleable.XTextView_text_color_normal, mView.getCurrentTextColor());
        mTextColorPressed = a.getColor(R.styleable.XTextView_text_color_pressed, 0);
        mTextColorUnable = a.getColor(R.styleable.XTextView_text_color_unable, 0);
        mTextColorSelected = a.getColor(R.styleable.XTextView_text_color_selected, 0);
        //typeface
        mTypefacePath = a.getString(R.styleable.XTextView_text_typeface);
        //drawableWithText
        mDrawableWithText = a.getBoolean(R.styleable.XTextView_icon_with_text, false);
    ...
    public TextViewHelper setTypeface(String typefacePath) {
    ...
    public TextViewHelper setIconNormal(Drawable icon) {
    ...
    public TextViewHelper setIconPressed(Drawable icon) {
    ...
    public TextViewHelper setIconUnable(Drawable icon) {
    ...
    public TextViewHelper setIconSelected(Drawable icon) {
    ...
    public TextViewHelper setIconSize(int iconWidth, int iconHeight) {
    ...
    public TextViewHelper setIconWidth(int iconWidth) {
        this.mIconWidth = iconWidth;
        setIcon();
        return this;
    }
    ...
    public TextViewHelper setIconHeight(int iconHeight) {
        this.mIconHeight = iconHeight;
        setIcon();
        return this;
    }
    ...
    public TextViewHelper setIconDirection(int iconDirection) {
    ...
    public TextViewHelper setTextColorNormal(@ColorInt int textColor) {
    ...
    public TextViewHelper setTextColorPressed(@ColorInt int textColor) {
    ...
    public TextViewHelper setTextColorUnable(@ColorInt int textColor) {
    ...
    public TextViewHelper setTextColorSelected(@ColorInt int textColor) {
    ...
    public TextViewHelper setTextColor(@ColorInt int normal, @ColorInt int pressed, @ColorInt int unable, @ColorInt int selected) {

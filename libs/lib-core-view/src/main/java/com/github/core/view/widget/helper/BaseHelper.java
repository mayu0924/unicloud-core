...
import com.github.core.view.widget.shadow.ShadowDrawable;


public class BaseHelper<T extends View> {
    /**
    ...
    public BaseHelper(Context context, T view, AttributeSet attrs) {
        mView = view;
        mContext = context;
     ...
     * @return
     */
    public BaseHelper setGradientType(int gradientType) {
    ...
    public BaseHelper setGradientOrientation(GradientDrawable.Orientation orientation) {
    ...
    public BaseHelper setStateBackgroundColor(@ColorInt int normal, @ColorInt int pressed, @ColorInt int unable, @ColorInt int checked, @ColorInt int selected) {
    ...
    public BaseHelper setStateBackgroundColorArray(int[] normalArray, int[] pressedArray, int[] unableArray, int[] checkedArray, int[] selectedArray) {
    ...
    public BaseHelper setStateBackgroundColor(Drawable normal, Drawable pressed, Drawable unable, Drawable checked, Drawable selected) {
    ...
    public BaseHelper setBackgroundColorNormal(@ColorInt int colorNormal) {
    ...
    public BaseHelper setBackgroundColorNormalArray(int[] colorNormalArray) {
    ...
    public BaseHelper setBackgroundDrawableNormal(Drawable drawableNormal) {
    ...
    public BaseHelper setBackgroundColorPressed(@ColorInt int colorPressed) {
    ...
    public BaseHelper setBackgroundColorPressedArray(int[] colorPressedArray) {
    ...
    public BaseHelper setBackgroundDrawablePressed(Drawable drawablePressed) {
    ...
    public BaseHelper setBackgroundColorUnable(@ColorInt int colorUnable) {
    ...
    public BaseHelper setBackgroundDrawableUnable(Drawable drawableUnable) {
    ...
    public BaseHelper setBackgroundColorUnableArray(int[] colorUnableArray) {
    ...
    public BaseHelper setBackgroundColorChecked(@ColorInt int colorChecked) {
    ...
    public BaseHelper setBackgroundColorSelected(@ColorInt int colorSelected) {
    ...
    public BaseHelper setBackgroundColorCheckedArray(int[] colorCheckedArray) {
    ...
    public BaseHelper setBackgroundColorSelectedArray(int[] colorSelectedArray) {
    ...
    public BaseHelper setBackgroundDrawableChecked(Drawable drawableChecked) {
    ...
    public BaseHelper setBackgroundDrawableSelected(Drawable drawableSelected) {
    ...
    public BaseHelper setShadowRadius(int shadowRadius) {
    ...
    public BaseHelper setShadowColor(int shadowColor) {
    ...
    public BaseHelper setShadowDx(int shadowDx) {
    ...
    public BaseHelper setShadowDy(int shadowDy) {
    ...
    public BaseHelper setUseRipple(boolean useRipple) {
    ...
    public BaseHelper setRippleColor(@ColorInt int rippleColor) {
    ...
    public BaseHelper setRippleMaskDrawable(Drawable rippleMaskDrawable) {
    ...
    public BaseHelper setBorderWidthNormal(int width) {
    ...
    public BaseHelper setBorderColorNormal(@ColorInt int color) {
    ...
    public BaseHelper setBorderWidthPressed(int width) {
    ...
    public BaseHelper setBorderColorPressed(@ColorInt int color) {
    ...
    public BaseHelper setBorderColorChecked(@ColorInt int color) {
    ...
    public BaseHelper setBorderColorSelected(@ColorInt int color) {
    ...
    public BaseHelper setBorderWidthChecked(int width) {
    ...
    public BaseHelper setBorderWidthSelected(int width) {
    ...
    public BaseHelper setBorderWidthUnable(int width) {
    ...
    public BaseHelper setBorderColorUnable(@ColorInt int color) {
    ...
    public BaseHelper setBorderWidth(int normal, int pressed, int unable, int checked,
                                     int selected) {
    ...
    public BaseHelper setBorderColor(@ColorInt int normal, @ColorInt int pressed,
    ...
    public BaseHelper setBorderDashWidth(float dashWidth) {
    ...
    public BaseHelper setBorderDashGap(float dashGap) {
    ...
    public BaseHelper setBorderDash(float dashWidth, float dashGap) {
        this.mBorderDashWidth = dashWidth;
        this.mBorderDashGap = dashGap;
        setBorder();
        return this;
    ...
    public BaseHelper setCornerRadiusTopLeft(float topLeft) {
    ...
    public BaseHelper setCornerRadiusTopRight(float topRight) {
        this.mCornerRadius = -1;
    ...
    public BaseHelper setCornerRadiusBottomRight(float bottomRight) {
        this.mCornerRadius = -1;
    ...
    public BaseHelper setCornerRadiusBottomLeft(float bottomLeft) {
        this.mCornerRadius = -1;
    ...
    public BaseHelper setCornerRadius(float topLeft, float topRight, float bottomRight,
                                      float bottomLeft) {
        this.mCornerRadius = -1;
        this.mCornerRadiusTopLeft = topLeft;
        this.mCornerRadiusTopRight = topRight;

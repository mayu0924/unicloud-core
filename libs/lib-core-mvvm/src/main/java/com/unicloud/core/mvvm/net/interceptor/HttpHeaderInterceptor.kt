...
class HttpHeaderInterceptor(private var mMapHeader: ConcurrentHashMap<String, String>?) :
    Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (BaseRetrofitClient.requestKeyMap.containsKey(requestKey)) {
            ...
            LogUtils.eTag("REPEAT-REQUEST",
                "重复请求:" + requestKey + "  ---------------重复请求 ----" + Thread.currentThread()
                    .getName()
            )

...
import com.unicloud.core.net.util.JsonUtils
...
object Printer {
    ...
    internal fun printJsonRequest(builder: HttpLoggingInterceptor, request: Request) {
    ...
    internal fun printJsonResponse(
        builder: HttpLoggingInterceptor, chainMs: Long, isSuccessful: Boolean,
    ...
    internal fun printFileRequest(builder: HttpLoggingInterceptor, request: Request) {
        val tag = builder.responseTag
        if (builder.logger == null)
            log(
                builder.type,
    ...
    private fun log(type: Int, tag: String, msg: String) {
        HttpLoggingInterceptor.Logger.DEFAULT.log(type, tag, msg)
    }
}
